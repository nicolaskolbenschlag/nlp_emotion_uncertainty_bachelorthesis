...
def evaluate_uncertainty_measurement_global_help(params, model, test_loader, val_loader):
    ...
    save_uncertainties_to_file(f"global_uncertainties_{params.uncertainty_approach}_{params.global_uncertainty_window}_{'_'.join(params.emo_dim_set)}_{test_loader.dataset.partition}", data_to_store)
